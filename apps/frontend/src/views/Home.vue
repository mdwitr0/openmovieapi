...
export default defineComponent({
  ...
  setup() {
    ...
    const pageData = ref({
      ...
      intro: {
        title: 'Свободная энциклопедия кино',
        description:
          'Получайте максимум данных о фильмах,\n' +
          'сериалах, мультфильмах, тв-шоу, аниме,\n' +
          'актерах режиссерах максимально\n' +
      ...
      graph: {
        title: 'Вся база КиноПоиска, IMDB и TMDB в одном API',
        ...
        pricingTables: [
          {
            title: 'Обучение',
            description:
              'Это тариф создан для некоммерческого использования API с целью обучения программированию. Идеален для студентов :)',
            items: [
              'Доступ ко всем методам api кинопоиска с ограничением 3 запроса в секунду',
      ...
      support: {
        title: 'Поддержка',
        description:
          'Мы не оставим Вас без поддержки, сотрудники openmovieapi.dev онлайн 24/7. Готовы решить практически любой ваш вопрос, а также - подсказать, помочь, обновить, загрузить, даже доработать код для корректной работы с API kinopoisk.dev. ',
        button: {
          text: 'Подключить',
          link: '#',
        },
